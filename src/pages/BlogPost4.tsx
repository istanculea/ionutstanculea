      ...
      <article className="container max-w-4xl mx-auto px-6 py-20">
        ...
        <header className="mb-12 space-y-6">
          ...
          <p className="text-xl text-muted-foreground">
            Secure remote access is a must in modern infrastructures—whether for remote teams, personal labs, or connecting multiple office sites. Over the years, I've repeatedly deployed OpenVPN servers across production and test environments, and I've refined a workflow that prioritizes speed, security, and reliability. In this post, I'll share a step-by-step approach to set up a functional OpenVPN server.
          </p>
        </header>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-gray-100 p-4 rounded-lg font-mono text-sm my-4">
            <code># Quick installation using automation script<br/>
            wget https://git.io/vpn -O openvpn-install.sh<br/>
            chmod +x openvpn-install.sh<br/>
            sudo ./openvpn-install.sh</code>
          </div>
          ...
          <div className="bg-gray-100 p-4 rounded-lg font-mono text-sm my-4">
            <code># Generate new client certificate<br/>
            sudo ./openvpn-install.sh<br/>
            # Select option to add new client<br/><br/>
            # Revoke client certificate<br/>
            sudo ./openvpn-install.sh<br/>
            # Select option to revoke existing client</code>
          </div>
          ...
          <div className="bg-gray-100 p-4 rounded-lg font-mono text-sm my-4">
            <code># Configure UFW firewall<br/>
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-6">
            ...
            <p className="text-yellow-700">
              Always use strong passwords for server access and implement fail2ban to prevent brute force attacks on SSH.
            </p>
          </div>
          ...
          <p>
            A typical client configuration file (.ovpn) includes:
          </p>
